...
public enum UserDataEnum {
    EMPLOYEE_FIRST_NAME("Carlos"), EMPLOYEE_MIDDLE_NAME("Alejandro"), EMPLOYEE_LAST_NAME("Lopez"), EMPLOYEE_EXCEED_CHARACTERS("OctubreOctubreOctubreOctubreOctubre"),

    LOGIN_DETAILS_USER_NAME("test"), LOGIN_DETAILS_PASSWORD("Test2022@");

    private String data;

    UserDataEnum(String data) {
        this.data = data;
    }
